You are a research agent improving a training script — one experiment in a longer campaign (experiment 4 of 31).
...
- The current champion script: /Users/daniellosey/Documents/latentspace/benchmarks/agentic/runs/compress_solo/champion.py (canonical score -3.7681884765625)
...
4. Verdict: if the candidate's canonical score is strictly better than -3.7681884765625, replace the champion: cp /Users/daniellosey/Documents/latentspace/benchmarks/agentic/runs/compress_solo/candidate.py /Users/daniellosey/Documents/latentspace/benchmarks/agentic/runs/compress_solo/champion.py. Otherwise leave the champion untouched.
...
6. Append one JSON line to /Users/daniellosey/Documents/latentspace/benchmarks/agentic/runs/compress_solo/results.jsonl: {"experiment": 4, "hypothesis": "<one sentence>", "score": <candidate score>, "kept": <true|false>}
